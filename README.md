...
This project demonstrates core AWS Identity and Access Management (IAM) concepts, including least privilege, custom JSON policies, MFA enforcement, and CloudTrail log analysis.
